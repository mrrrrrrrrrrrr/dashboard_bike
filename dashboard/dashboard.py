...
st.sidebar.markdown("**• Nama: Merryvelliane Fitriatasa Fujianto**")
st.sidebar.markdown(
    "**• Email: [m006d4kx2262@bangkit.academy](m006d4kx2262@bangkit.academy)**")
st.sidebar.markdown(
    "**• Github: [merryvelliane](https://github.com/mrrrrrrrrrrrr/dashboard_bike/blob/main/dashboard/dashboard.py)**")
